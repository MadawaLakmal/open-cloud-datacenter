...
// getFirstFoundEnvTestBinaryDir returns the first envtest binary directory
// found under bin/k8s/. Mirrors the pattern in keyvault and database suites.
// Run `make setup-envtest` to populate it.
