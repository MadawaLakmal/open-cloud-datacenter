...
import (
	...
	"github.com/wso2/open-cloud-datacenter/operators/registry/internal/controller"
...
func main() {
	...
	// Disable HTTP/2 by default; mitigates CVE-2023-44487 and CVE-2023-39325.
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "registry-operator.opencloud.wso2.com",
	})
	if err != nil {
	...
	if err := (&controller.RegistryBackendReconciler{
		...
		setupLog.Error(err, "failed to create controller", "controller", "registrybackend")
		os.Exit(1)
	}
